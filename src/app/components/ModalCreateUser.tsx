...
const ModalCreateUser = ({ isOpen, onClose, email }) => {
            ...
            >
              ...
              <div className="my-8 text-center">
                ...
                <h4 className="text-xl text-gray-800 font-semibold mt-4">
                  The activation letter has been sent successfully!
                </h4>
                <p className="text-sm text-gray-500 leading-relaxed mt-4">
                  Please activate your account according to the instructions
                  just sent to the email: {email}
                </p>
              </div>
              <button
                type="button"
              ...
              >
                <Link href="https://mail.google.com/mail/u/1/#inbox" passHref>
                  Got it
                </Link>
              </button>
            </div>
